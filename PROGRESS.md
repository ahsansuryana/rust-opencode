...
| 5 | oc-tool (bag. 1: filesystem) | in-progress | 2026-08-23 | Sprint-5a DONE & hijau: framework Tool/Registry, path safety shared, Read/Write/Glob/Grep (deskripsi .txt verbatim via include_str), adapter ripgrep + fallback. 5b: Edit tool (737 baris TS), registry penuh (agent filter/permission arity), truncation. Golden vs TS runner menunggu env bun |
